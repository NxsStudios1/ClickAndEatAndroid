// com/example/login/cliente/ComentariosClienteAdapter.java
...
public class ComentariosClienteAdapter
    ...
    public void onBindViewHolder(@NonNull ViewHolder h, int position) {
        ...
        if (item.contenidoRespuesta != null
            ...
            String nomAdmin = item.nombreAdmin != null ? item.nombreAdmin : "";
            h.tvNombreAdmin.setText("Administrador: " + nomAdmin);

            h.tvFechaRespuesta.setText(
                    item.fechaRespuesta != null ? item.fechaRespuesta : "");
    ...
    static class ViewHolder extends RecyclerView.ViewHolder {
        ...
        ViewHolder(@NonNull View itemView,
            ...
            // Click para admin (para cliente puede ser null)
